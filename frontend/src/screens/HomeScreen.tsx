...
export function HomeScreen() {
    ...
    const pets = [
        ...
        },
        {
            ...
            breed: 'Pug',
            description:
                'A small but energetic dog, always happy to see people.',
            age: 2,
            weight: '8kg',
            gender: 'Male',
            owner: 'Sarah Lee',
        ...
        },
        {
            ...
            breed: 'Maine Coon',
            description:
                'A large and fluffy cat, loves to be the center of attention.',
            age: 5,
            weight: '6.5kg',
            gender: 'Male',
            owner: 'David Green',
        ...
        },
        {
            ...
            breed: 'Labrador',
            description:
                'A friendly dog with a love for water and playing fetch.',
            age: 3,
            weight: '22kg',
            gender: 'Female',
            owner: 'Alice Brown',
