...
const NumberVerificationWithNumber: React.FC = () => {
  const [phoneNumber, setPhoneNumber] = useState("7894721848"); // Thay đổi state cho số điện thoại
...
export default NumberVerificationWithNumber;
